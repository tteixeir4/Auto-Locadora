...
<body>
    ...
    <button onclick="document.location='cadastrarmarca.php'">Cadastrar Marca</button>
    <fieldset>
    ...
    <div>
        <iframe src="listarMarca.php" class="iframe"></iframe>
    </div>
    <script>
        ...
        busca.addEventListener('keyup', () => {
            ...
            if (termo.length > 1) {
                fetch(`buscarmarca.php?termo=${encodeURIComponent(termo)}`)
                    .then(res => res.text())
                    .then(data => {
